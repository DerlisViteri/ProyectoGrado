...
<div class="container">
    <h1 class="text-center mb-4">GENERAR ORDEN</h1>
    ...
    <div class="table">
        <table class="table table-bordered table-striped table-light table-sm">
            <thead class="thead-light">
                <tr>
                    <th class="bg-secondary text-light">Secuencial</th>
                    <th class="bg-secondary text-light">Fecha</th>
                    <th class="bg-secondary text-light">Jornada</th>
                    <th class="bg-secondary text-light">Mes</th>
                    <th class="bg-secondary text-light">Año Lectivo</th>
                    <th class="bg-secondary text-light">Acciones</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <!-- Botón para ver -->
                        <a href="{{ route('mostrar', $o->especial) }}" class="btn btn-outline-info btn-sm"> <!-- Agregué "#" en el href -->
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-eye-fill" viewBox="0 0 16 16">
                        ...
                        <!-- Botón de excel -->
                        <a   href="{{ route('Orden.export', $o->especial) }}" class="btn btn-outline-success btn-sm ">
